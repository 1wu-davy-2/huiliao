...
const PURPOSE_EXAMPLES: Record<PurposeKey, ExampleSpec[]> = {
  ...
  invite: [
    ...
    {
      tone: '稳重',
      text: '如果只是想见一面聊聊天也可以；想约更进一步的见面，我希望先把期望说清，你随时可以说不。',
      why: '适合可能涉及约炮/只约的语境：先对齐关系类型，邀约仍保留拒绝出口。',
    },
  ],
  clarify: [
    {
  ...
  intimacy: [
    ...
    {
      tone: '轻松',
      text: '如果只是约一次：安全套我备着；你犹豫或只想接吻也可以，不会用「都出来了」逼你。不拍、不对朋友讲细节。',
      why: '约炮/一夜情语境下，把保护、降级和保密说成可执行安排，而不是征服话术。',
    },
    {
      tone: '稳重',
